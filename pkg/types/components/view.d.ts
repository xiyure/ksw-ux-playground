...
import { TreeNodeData, NodeDropType } from 'element-plus/es/components/tree/src/tree.type';
...
export type KViewEmits = {
  ...
  drag: (dragData:{ targetNode: any, lastOverNode: any, position: NodeDropType }) => void,
...
export interface KViewSlots {
  ...
  label: (_: ViewData) => ComponentSlotType
