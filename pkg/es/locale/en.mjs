const e = {
  ...
  scriptInput: {
    ...
    modelTipTitle: "Click to switch input mode",
    modelTipContent_s: "Text mode, supporting mixed input of text and variables",
    modelTipContent_e: "Expression mode, supports inputting Python expression"
  },
  dialog: {
    confirm: "confirm",
    cancel: "cancel"
