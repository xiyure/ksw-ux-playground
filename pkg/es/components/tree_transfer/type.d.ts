...
import { Column, SearchConfig, TablePaginationConfig, TreeConfig, ScrollY } from '../tree_table/type';
...
export type TreeTransferCacheData = {
    treeDataMap: Map<string | number, TreeTransferData>;
    tableDataMap: Map<string | number, {
        node: TreeTransferData;
        children: TreeTransferData[];
    }>;
};
