import { defineComponent as _, computed as m, resolveComponent as r, createElementBlock as s, openBlock as e, createElementVNode as a, renderSlot as l, createCommentVNode as o, createStaticVNode as w, createTextVNode as k, toDisplayString as i, normalizeStyle as d, createBlock as c } from "vue";
const y = {
  id: "KResult",
  class: "k-result"
  ...
  key: 1,
  class: "def-bg"
}, S = { key: 1 }, x = { key: 3 }, N = { style: { display: "flex", "flex-direction": "column", "align-items": "center" } }, V = {
  key: 0,
  class: "base-title"
}, Z = {
  key: 1,
  class: "base-title"
}, T = { class: "base-subTitle" }, $ = { style: { display: "flex" } }, E = /* @__PURE__ */ _({
  name: "KResult",
  __name: "result",
  props: {
    status: { default: "" },
  ...
  setup(u) {
    const f = u, h = ["403", "404", "500"], p = ["success", "warning", "info", "error"], n = m(() => {
      switch (f.status) {
        case "403":
    ...
    return (t, q) => {
      const C = r("IconLocked"), v = r("IconCheck"), g = r("IconClose");
      return e(), s("div", y, [
        a("div", F, [
          l(t.$slots, "icon", {}, () => [
            h.includes(t.status) ? (e(), s("div", L, [
              a("h1", { "data-h1": t.status }, [
                ...
                a("div", {
                  ...
                  style: d({ backgroundColor: n.value.color })
                }, [
                  t.status == "403" ? (e(), c(C, {
                    key: 0,
                    size: "1.8vw",
            ...
            p.includes(t.status) ? (e(), s("div", M, [
              a("div", {
                ...
                t.status == "warning" ? (e(), s("span", S, "!")) : o("", !0),
                t.status == "error" ? (e(), c(g, {
                  key: 2,
                  size: "1.8vw",
                  color: "#FFFFFF"
                })) : o("", !0),
                t.status == "info" ? (e(), s("span", x, "i")) : o("", !0)
              ], 4)
            ])) : o("", !0)
          ], !0)
        ]),
        l(t.$slots, "title", {}, () => [
          a("div", N, [
            t.title ? (e(), s("p", Z, i(t.title), 1)) : (e(), s("p", V, i(n.value.title), 1)),
            a("p", T, i(t.content), 1)
          ])
        ], !0),
        a("div", $, [
